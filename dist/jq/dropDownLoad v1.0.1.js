...
var dropDownLoad = {
    ...
    init: function (set) {
        ...
        var temp = $('<link rel="stylesheet" href="inc/su_animate.css" media="screen" title="no title" charset="utf-8">'),
            temp2 = $('<link rel="stylesheet" href="inc/su_loaders.min.css" media="screen" title="no title" charset="utf-8">');
        $('head').append(temp);
        $('head').append(temp2);
    ...
    ajax: function () {
        ...
        if (this.opt.totalPage && this.opt.page++ == this.opt.totalPage) {
